...
%
% $Id: faq-ja.tex,v 1.7 2017/05/19 16:19:33 sfeam Exp $
% translated to Japanese by Shigeharu TAKENO
% Original: Id: faq.tex,v 1.57 2015/01/01 01:23:06 sfeam Exp
%
...
%% end Japanese
        \\
%%% FAQ version
%%% \verb+Revision: 1.57 +, dated
%%% \verb+Date: 2015/01/01 01:23:06 +.
% <== 本当は \verb++ の内側に $ がついている
この FAQ のバージョンは %
\verb+$+\verb+Revision: 1.57 $+,
\verb+$+\verb+Date: 2015/01/01 01:23:06 $+ です。
...
%%% to display
%%% pretabulated data.  It also offers a few options for accumulating 
%%% raw data
...
それを \http{sourceforge.net/p/gnuplot/bugs} の
